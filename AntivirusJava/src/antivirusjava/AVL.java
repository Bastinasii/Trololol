 ...
 */
public class AVL {
    protected nodAVL root; // the root node
...
/***************************** Core Functions ************************************/
  ...
  */
 public void insertAVL(nodAVL p, nodAVL q) {
  ...
  */
 public void removeAVL(nodAVL p,int q) {
  if(p==null) {
  ...
  */
 public void removeFoundNode(nodAVL q) {
  nodAVL r;
  ...
  */
 public nodAVL rotateLeft(nodAVL n) {
  ...
  */
 public nodAVL rotateRight(nodAVL n) {
  ...
  */
 public nodAVL doubleRotateLeftRight(nodAVL u) {
  ...
  * @return The root after the double rotation.
  */
 public nodAVL doubleRotateRightLeft(nodAVL u) {
...
/***************************** Helper Functions ************************************/
  ...
  */
 public nodAVL successor(nodAVL q) {
  if(q.right!=null) {
   nodAVL r = q.right;
   while(r.left!=null) {
    r = r.left;
 ...
 private void setBalance(nodAVL cur) {
